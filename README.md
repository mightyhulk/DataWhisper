...
<div align="center">
  <img src="data/docs/datawhisper.png" >
...
1. Create a virtual environment: `python -m venv datawhisper_venv`
2. Activate the virtual environment : `.\datawhisper_venv\Scripts\activate` on Windows.
3. Run the following command in the directory: `cd datawhisper_chatbot`
4. Install the required dependencies `pip install -r requirements.txt`
5. Start the app: `streamlit run chat_app.py`
